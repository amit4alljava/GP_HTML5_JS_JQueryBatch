...
// Search in TextBox
    document.getElementById("taskName").addEventListener("keyup",searchTask);
});

function searchTask(){
    var taskName = document.getElementById("taskName").value;
    var taskList  = taskOperations.getTaskByName(taskName);
    var ulTag = document.getElementsByTagName("ul")[0];
    ulTag.innerHTML = "";
    taskList.forEach(function(taskListObject,index){
...
function loadJSON(){
    alert("*********All Data  Coming from the Server...");
